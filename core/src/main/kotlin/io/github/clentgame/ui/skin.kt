package io.github.clentgame.ui
...
fun loadSkin(){
    Scene2DSkin.defaultSkin = skin(TextureAtlas("ui/ui.atlas")){skin ->
        loadSkinFonts(skin)
        loadSkinLabels(skin)
        loadSkinButtons(skin)

    }
}

private fun @SkinDsl Skin.loadSkinButtons(skin: Skin){
    textButton(Buttons.TEXT_BUTTON.skinkey){
        font = skin[Fonts.DEFAULT]
    }
}

private fun @SkinDsl Skin.loadSkinLabels(skin: Skin) {
...
private fun loadSkinFonts(skin: Skin) {
