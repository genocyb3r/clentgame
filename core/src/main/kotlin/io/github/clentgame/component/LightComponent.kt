...
data class LightComponent(
    ...
    companion object {
        val lightColor = Color(1f, 1f, 1f, 0.6f)
        const val playerCategory: Short = 2
        const val slimeCategory: Short = 4
        const val environmentCategory: Short = 8
        ...
        class LightComponentListener: ComponentListener<LightComponent>{
            ...
            override fun onComponentRemoved(entity: Entity, component: LightComponent) = with(component){
